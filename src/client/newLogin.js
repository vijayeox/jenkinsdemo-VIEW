...
export default class oxLogin extends Login {
  render(startHidden) {
    ...
    const view = (state, actions) =>
      h("main", {
        id: 'login-container ',
        className: 'row  deep-purple lighten-3 '
      }, [

        h('div', {
          id: 'ox-content',
          className: 'col s8  deep-purple lighten-3 ',
          style: 'padding: 0px;'
        }, [
          h("br"),
          h('div', {
          ...
          h('div', {
            id: 'footer',
            className: 'ox-content-footer purple darken-4 footer'
          }, [
            h('span', {
              className: 'footer-CR'
            }, 'Copyright © 2004-2019 Vantage Agora. All rights reserved.'),
            h('span', {
        ...
        h('div', {
          id: 'ox-login-form',
          className: 'col s4 grey lighten-5 right-align'
        }, [
          h("form", {
            action: "#",
            method: "post",
          ...
          h('div', {
            id: 'filler',
            className: 'form-filler grey lighten-5'
          })
        ])
    ...
    const a = app(Object.assign({
      hidden: startHidden
    }, login), actions, view, document.body);
