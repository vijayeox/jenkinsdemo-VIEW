...
class WidgetEditorBody extends AbstractEditor {
    ...
    getTargetFieldList() {
        ...
        targetColumn.map((item, index) => {
            this.state.targetFields.push({ label: item.dataFields.categoryX, value: item.dataFields.valueY })
        });
    }
