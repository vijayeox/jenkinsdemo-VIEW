 ...
 */
// Added by Nikhil S Vantage Agora
function isProtoElement(el) {
    var proto = el['__proto__'];
    var flag = true;
    while (flag) {
        try {
            if (proto['constructor'].name == "Element") {
                flag = false;
                return true;
            }
            else {
...
export function getElement(el) {
    ...
    else if (isProtoElement(el)) { //insted of checking instanceof By Nikhil S
        return el;
    }
}
/**
